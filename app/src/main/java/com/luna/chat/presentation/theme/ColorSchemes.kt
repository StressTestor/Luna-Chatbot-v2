...
/**
 * Material Design 3 color schemes for all Luna themes
 */
object LunaColorSchemes {
    ...
    /**
     * Gets the appropriate color scheme for a given theme ID
     */
    fun getColorSchemeForTheme(themeId: String): ColorScheme {
        return when (themeId) {
            ...
            else -> RainbowLightColorScheme // Default fallback
        }
    }
    
    /**
     * Checks if a theme uses dark mode
     */
